...
public class DBConnectionMgr {
    ...
    _url = "jdbc:mysql://127.0.0.1:3306/mydb?useUnicode=true&characterEncoding=EUC-KR&serverTimezone=Asia/Seoul",
    _user = "root",
    _password = "1234";
    ...
    public synchronized Connection getConnection()
        ...
        if (!initialized) {
            ...
            DriverManager.registerDriver((Driver) c.getConstructor().newInstance());
            initialized = true;
        }
        Connection c = null;
        ConnectionObject co = null;
